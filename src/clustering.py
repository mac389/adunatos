"""
Taken from @xapple's posting on Active State
...
class HiearchicalHeatmap(object):
    ...
    def plot(self):
        ...
        pyplot.savefig('../images/cluster.tiff')
...
df = pandas.read_json('../gene-expression-by-area2.json')
no_na = df.dropna(axis=1)
analysis = HiearchicalHeatmap(no_na)
analysis.plot()