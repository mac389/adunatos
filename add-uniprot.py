...
csv = True
if csv:
	selectively_upregulated_genes = pd.read_csv('differentially-expressed-genes.csv')	
else:
...
selectively_upregulated_genes.to_csv('differentially-expressed-genes-with-uniprot.csv')
